...
class CommunityOrganizerController(
    ...
    @GetMapping
    fun getOrganizers(@PathVariable("community_id") communityId: Long): List<CommunityOrganizerResponse> {
        return communityOrganizerService.getOrganizersByCommunityId(communityId)
    }
